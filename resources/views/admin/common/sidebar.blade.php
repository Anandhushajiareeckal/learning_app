        ...
        @endcanany
            <li>
                <a class="has-arrow" href="#">
                    ...
                    <span>{{__('Manage Exam')}}</span>
                </a>
                <ul>
                        <li class="{{ active_if_match('admin/scholarships') }}">
                            <a href="{{route('admin.scholarship')}}">
                                <i class="fa fa-circle"></i>
                                <span>{{__('Schoarship')}}</span>
                            </a>
                        </li>

                        <li class="{{ active_if_match('admin/scholarships/get_scholarship_list') }}">
                            <a href="{{route('admin.get_scholarship_list')}}">
                                <i class="fa fa-circle"></i>
                                <span>{{__('Result')}}</span>
                            </a>
                        </li>

                        <li class="{{ active_if_match('admin/scholarships/rank_calculation') }}">
                            <a href="{{route('admin.rank_calculation')}}">
                                <i class="fa fa-circle"></i>
                                <span>{{__('Rank calculation')}}</span>
                            </a>
                        </li>

                        <li class="{{ active_if_match('admin/quiz') }}">
                        ...
                        <li class="{{ active_if_match('admin/mock') }}">
                            <a href="{{route('admin.mock')}}">
                                <i class="fa fa-circle"></i>
                                <span>{{__('Mock Test')}}</span>
                            </a>
                        </li>

                        <li class="{{ active_if_match('admin/linkk') }}">
