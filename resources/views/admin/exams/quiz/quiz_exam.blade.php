                ...
                <div class="col-md-12">
                    <div class="customers__area bg-style mb-30">
                        <div class="item-title d-flex justify-content-between">
                            ...
                            <a href="{{ route('admin.quiz_exams_add',['id'=>$id]) }}" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i> {{__('Add Quiz')}} </a>
                        </div>
                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                <a href="{{  route('admin.quiz_exam_edit',['id' =>$data->id])}}" class="btn-action" title="Edit">
                                                    <img src="{{ asset('admin/images/icons/edit-2.svg') }}" alt="edit">
                                                </a>
                                                
                                                <a href="javascript:void(0);" data-url="{{  route('admin.quiz_exam_destroy',['id' =>$data->id])}}" class="btn-action delete" title="Delete">
