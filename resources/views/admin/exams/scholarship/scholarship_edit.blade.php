                        ...
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{__('Add Scholarship')}}</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-vertical__item bg-style">
                            ...
                            <form action="{{route('admin.scholarship_update',['id'=>$scholarship->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')                             
                                <div class="input__group mb-25">
                                    <label for="name"> {{__('Heading')}} </label>
                                    <div>
                                        <input type="text" name="heading" id="name" value="{{$scholarship->heading}}"  class="form-control" placeholder="{{__('Heading')}} ">
                                        @if ($errors->has('name'))
                                ...
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="description" value="{{ $scholarship->description }}" placeholder="{{ __('Description') }}" class="form-control">
                                ...
                                <div class="input__group mb-25">
                                    ...
                                    <div class="upload-img-box" style="width: 100px; height:100px;">
                                        ...
                                        <input type="file" name="image" id="og_image" value="{{$scholarship->icon}}" accept="image/*" onchange="previewFile(this)">
