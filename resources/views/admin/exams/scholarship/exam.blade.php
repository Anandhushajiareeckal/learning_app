                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @if ($time != null)
                                    ...
                                    <form class="form-floating" action="{{route('admin.scholarship_time_update',['id'=>$time->id])}}" method="POST" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                ...
                                @elseif(isset($scholarships_exams[0]->scho_id))
                                    <form class="form-floating" action="{{route('admin.scholarship_time', ['scho_id'=>$scholarships_exams[0]->scho_id])}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-12 pb-5">
                                            <span class="form-floating">
                                ...
                                @else
                                    <h5 style="text-align: center; color:red;">Add questions</h5>
                ...
                <div class="col-md-12">
                    <div class="customers__area bg-style mb-30">
                        <div class="item-title d-flex justify-content-between">
                            ...
                            <a href="{{route('admin.scholarships_exams_add',['id'=>$id])}}" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i> {{__('Add Question')}} </a>
                        </div>
                        <div class="customers__table">
                            <table id="customers-table" class="row-border data-table-filter table-style">
                                ...
                                <tbody>
                                @foreach($scholarships_exams as $data)
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                <a href="{{route('admin.scholarships_exam_edit',['id'=>$data->id])}}" class="btn-action" title="Edit">
                                                    <img src="{{ asset('admin/images/icons/edit-2.svg') }}" alt="edit">
                                                </a>
                                                
                                                <a href="javascript:void(0);" data-url="{{route('admin.scholarships_exam_destroy',['id'=>$data->id])}}" class="btn-action delete" title="Delete">
