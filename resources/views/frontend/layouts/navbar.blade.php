                ...
                <div class="header-nav-left-side me-auto d-flex">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0 " style="margin-left: 20px">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu {{$selectedLanguage->rtl == 1 ? 'dropdown-menu-end' : ''}}">
                                <li>
                                    <a href="/student/scholarship"class="dropdown-item "> Scholarship</a>
                                </li>

                                <li>
                                    <a href="/student/quiz"class="dropdown-item "> Quiz</a>
                                </li>

                                <li>
                                    <a href="/student/mock-test"class="dropdown-item "> Mock Test</a>
                                </li>
