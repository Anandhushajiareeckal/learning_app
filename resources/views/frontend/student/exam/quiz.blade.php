                    ...
                    <div class="col-md-4">
                        <div class="single-feature-item d-flex align-items-center">
                            <div class="flex-shrink-0 feature-img-wrap">
                                <a href="{{$link->subdomain}}/quiz_questions/{{$item->id}}"><img src="{{$item->icon}}" alt="feature" style="width: 80px; height:80px;"></a>
                            </div>
                            <div class="flex-grow-1 ms-3 feature-content">
                                <h6><a href="{{$link->subdomain}}/quiz_questions/{{$item->id}}">{{$item->heading}}</a>
                                </h6>
