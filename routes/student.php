...
Route::group(['as' => 'student.'], function () {
    ...
    Route::get('/scholarship_questions/{id}', [ExamController::class, 'scholarship_questions'])->name('scholarship_questions');


    Route::get('/scholarship', [ExamController::class, 'scholarships_registration'])->name('scholarships_registration');
    Route::post('/scholarships_registration_store', [ExamController::class, 'scholarships_registration_store'])->name('scholarships_registration_store');
    Route::get('/scholarship_list', [ExamController::class, 'scholarships'])->name('scholarship_list');

    Route::get('/quiz', [ExamController::class, 'quiz'])->name('quiz');
    Route::get('/mock-test', [ExamController::class, 'mock'])->name('mock');
