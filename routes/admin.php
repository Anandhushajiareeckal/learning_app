...
Route::prefix('scholarships')->group(function () {
    Route::get('/', [ExamController::class, 'index'])->name('admin.scholarship');
    Route::get('/add', [ExamController::class, 'scholarship_add'])->name('admin.scholarship_add');
    Route::post('/store', [ExamController::class, 'scholarship_store'])->name('admin.scholarship_store');
    Route::get('/edit/{id}', [ExamController::class, 'scholarship_edit'])->name('admin.scholarship_edit');
    Route::put('/update/{id}', [ExamController::class, 'scholarship_update'])->name('admin.scholarship_update');
    Route::get('/delete/{id}', [ExamController::class, 'scholarships_destroy'])->name('admin.scholarships_destroy');

    Route::get('/exams/{id}', [ExamController::class,'scholarships_exams'])->name('scholarship_exams');
    Route::get('/exams/add/{id}', [ExamController::class,'scholarships_exams_add'])->name('admin.scholarships_exams_add');
    Route::post('/exams/store/{id}', [ExamController::class,'scholarships_exam_store'])->name('admin.scholarships_exam_store');
    Route::get('/exams/edit/{id}', [ExamController::class,'scholarships_exam_edit'])->name('admin.scholarships_exam_edit');
    Route::put('/exams/update/{id}', [ExamController::class,'scholarships_exam_update'])->name('admin.scholarships_exam_update');
    Route::get('/exams/delete/{id}', [ExamController::class,'scholarships_exam_destroy'])->name('admin.scholarships_exam_destroy');

    Route::post('/scholarship_time/{scho_id}', [ExamController::class,'scholarship_time'])->name('admin.scholarship_time');
    Route::put('/scholarship_time/{id}', [ExamController::class,'scholarship_time_update'])->name('admin.scholarship_time_update');

    Route::get('/get_scholarship_list', [ExamController::class,'get_scholarship_list'])->name('admin.get_scholarship_list');
    Route::get('/results/{id}', [ExamController::class,'results'])->name('admin.results');
    Route::get('/exam_details/{id}', [ExamController::class,'exam_details'])->name('admin.exam_details');
    
    
    Route::get('rank_calculation', [ExamController::class,'rank_calculation'])->name('admin.rank_calculation');
    Route::get('rank_calculate/{id}', [ExamController::class,'rank_calculate'])->name('admin.rank_calculate');
    Route::get('view_rank_list/{id}', [ExamController::class,'view_rank_list'])->name('admin.view_rank_list');
...
Route::prefix('quiz')->group(function () {
    Route::get('/', [ExamController::class, 'quiz'])->name('admin.quiz');
    Route::get('/add', [ExamController::class, 'quiz_add'])->name('admin.quiz_add');
    Route::post('/store', [ExamController::class, 'quiz_store'])->name('admin.quiz_store');
    Route::get('/edit/{id}', [ExamController::class, 'quiz_edit'])->name('admin.quiz_edit');
    Route::put('/update/{id}', [ExamController::class, 'quiz_update'])->name('admin.quiz_update');
    Route::get('/delete/{id}', [ExamController::class, 'quiz_destroy'])->name('admin.quiz_destroy');

    Route::get('/exams/{id}', [ExamController::class, 'quiz_exams'])->name('admin.quiz_exams');
    Route::get('/exams/add/{id}', [ExamController::class, 'quiz_exams_add'])->name('admin.quiz_exams_add');
    Route::post('/exams/store/{id}', [ExamController::class, 'quiz_exam_store'])->name('admin.quiz_exam_store');
    Route::get('/exams/edit/{id}', [ExamController::class, 'quiz_exam_edit'])->name('admin.quiz_exam_edit');
    Route::put('/exams/update/{id}', [ExamController::class, 'quiz_exam_update'])->name('admin.quiz_exam_update');
    Route::get('/exams/delete/{id}', [ExamController::class, 'quiz_exam_destroy'])->name('admin.quiz_exam_destroy');
    Route::post("/quiz/registration", [ExamController::class, 'quiz_registration_store'])->name('admin.quiz_registration_store');
});



Route::prefix('mock')->group(function () {
    Route::get('/', [ExamController::class, 'mock'])->name('admin.mock');
    
    Route::get('/add', [ExamController::class, 'mock_add'])->name('admin.mock_add');
    Route::post('/store', [ExamController::class, 'mock_store'])->name('admin.mock_store');
    Route::get('/edit/{id}', [ExamController::class, 'mock_edit'])->name('admin.mock_edit');
    Route::put('/update/{id}', [ExamController::class, 'mock_update'])->name('admin.mock_update');
    Route::get('/delete/{id}', [ExamController::class, 'mock_destroy'])->name('admin.mock_destroy');

    Route::get('/exams/{id}', [ExamController::class, 'mock_exams'])->name('admin.mock_exams');
    Route::get('/exams/add/{id}', [ExamController::class, 'mock_exams_add'])->name('admin.mock_exams_add');
    Route::post('/exams/store/{id}', [ExamController::class, 'mock_exam_store'])->name('admin.mock_exam_store');
    Route::get('/exams/edit/{id}', [ExamController::class, 'mock_exam_edit'])->name('admin.mock_exam_edit');
    Route::put('/exams/update/{id}', [ExamController::class, 'mock_exam_update'])->name('admin.mock_exam_update');
    Route::get('/exams/delete/{id}', [ExamController::class, 'mock_exam_destroy'])->name('admin.mock_exam_destroy');
    Route::post("/mock/registration", [ExamController::class, 'mock_registration_store'])->name('admin.1mock_registration_store');

});

Route::prefix('linkk')->group(function () {
    Route::get('/', [ExamController::class, 'link'])->name('admin.link');
    Route::put('/link-store', [ExamController::class, 'link_store'])->name('admin.link-store');
